...
struct bcm2835_i2c_dev *my_i2c_dev;
char my_data[]="my_tasklet_started";
...
void my_i2c_start_transfer(unsigned long data)
{
	u32 c = BCM2835_I2C_C_ST | BCM2835_I2C_C_I2CEN;
	struct i2c_msg *msg = i2c_dev->curr_msg;
	bool last_msg = (i2c_dev->num_msgs == 1);
...
DECLARE_TASKLET(my_tasklet,&my_i2c_start_transfer);
...
static int bcm2835_i2c_probe(struct platform_device *pdev)
{
	...
	if (ret) {
        ...
        tasklet_init(my_tasklet,&bcm2835_i2c_start_transfer,0);
#endif
