...
static ssize_t  ds1307_write(struct file *filp, const char *buf, size_t len, loff_t * off)
{
	...
	i2c_smbus_write_byte_data(ds1307_client,DS1307_REG_MONTH, bin2bcd(month+1));
	i2c_smbus_write_byte_data(ds1307_client,DS1307_REG_YEAR, bin2bcd(year-100));
...
static int __init ds1307_entry(void)
{
	...
	if(IS_ERR(device_create(ds1307_class,NULL,ds1307_dev,NULL,"ds1307_mycstm")))
	{
